...
int main(int argc, char *argv[])
{
    ...
    compile_shader(vs_shader, "glsl/transform.vert");
    ...
    /* prepare a simple scale transformation as this is the easier matrix to create */
    GLuint transform = glGetUniformLocation(program, "transform");
    GLfloat scale_transform[] = {
        2.f, 0.f, 0.f, 0.f,
        0.f, 2.f, 0.f, 0.f,
        0.f, 0.f, 2.f, 0.f,
        0.f, 0.f, 0.f, 1.f
    };
    glUniformMatrix4fv(transform, 1, GL_FALSE, scale_transform);
